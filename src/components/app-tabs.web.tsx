...
function TabButton({ children, isFocused, ...props }: TabTriggerSlotProps) {
  return <Pressable {...props} className={isFocused ? 'flex-1 items-center rounded-xl bg-zinc-950 px-6 py-3' : 'flex-1 items-center rounded-xl px-6 py-3'}>
...
export default function AppTabs() {
  return <Tabs style={{ flex: 1 }}>
    ...
    <TabList asChild>
      <View className="mx-auto w-full max-w-xl flex-row justify-center gap-3 border-t border-zinc-200 bg-white px-5 py-3">
