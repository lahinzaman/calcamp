// Livingston coordinates: embedded map on recreation.rutgers.edu/facilities/livingston.
// Approximate campus building coordinates (sources in docs-phase-6.md); 150 m radii tolerate normal GPS drift. Eight regions stay below iOS's limit of 20.
export const CAMPUS_REGIONS = [
  ...
  { identifier: 'gym:livingston', latitude: 40.521078557210906, longitude: -74.43302208480678 },
