  ...
  return <View>
    ...
    <Modal presentationStyle="pageSheet" animationType="slide" visible={prompt} onRequestClose={() => setPrompt(false)}>
      <SafeAreaView className="flex-1 bg-background"><ScrollView contentContainerStyle={{ padding: 24 }}>
        ...
        <Text className="mt-3 leading-6">CalCamp reads today's steps and active energy. On iOS, recent workouts appear separately from your lifting diary. Completed CalCamp workouts will be exported automatically while connected. Dietary energy is shared only when you request an export. You can change access in your device's Health settings.</Text>
